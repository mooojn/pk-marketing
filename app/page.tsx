      ...
      <section className="relative min-h-screen overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
        ...
        <div className="relative z-10 min-h-screen flex pt-20">
          ...
          >
            ...
            {/* Featured Card */}
            <div
              className="absolute top-1/2 -translate-y-1/2 -left-20 w-80 p-8 backdrop-blur-sm"
              style={{
            ...
            >
              ...
              <div
                ...
                style={{ background: 'linear-gradient(90deg, var(--accent-warm), var(--accent-coral), var(--accent-sage))' }}
              />
              ...
              >
                A revolutionary analytics platform that transforms complex data into actionable insights.
              </p>

              <a
                href="#"
                className="inline-flex items-center gap-2 text-sm tracking-wider transition-all duration-300"
                style={{
                  fontFamily: 'var(--font-mono)',
                  color: 'var(--accent-warm)'
                }}
