            ...
            >
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="hidden md:flex items-center gap-10">
                            {[
                                ...
                                <Link
                                    ...
                                    style={{ fontFamily: 'var(--font-display)', color: item.name === 'About' ? 'var(--accent-warm)' : 'var(--text-muted)' }}
                                >
                                    {item.name}
                                </Link>
                            ))}
                        ...
                        <button className="md:hidden p-2" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} style={{ color: 'var(--text-primary)' }}>
                        ...
                        <div className="md:hidden py-6 border-t" style={{ borderColor: 'var(--border-subtle)', background: 'var(--bg-primary)' }}>
                            <div className="flex flex-col gap-4">
                                {[{ name: 'Home', href: '/' }, { name: 'About', href: '/about' }, { name: 'Services', href: '/#services' }, { name: 'Contact', href: '/contact' }].map((item) => (
                                    <Link key={item.name} href={item.href} className="text-sm tracking-wider uppercase py-2" style={{ fontFamily: 'var(--font-mono)', color: 'var(--text-muted)' }} onClick={() => setIsMobileMenuOpen(false)}>
                                        {item.name}
                                    </Link>
                                ))}
                            </div>
